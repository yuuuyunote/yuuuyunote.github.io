...
var GBP_TOOLS = [
  ...
  { id:'channel-url-extract', title:'チャンネルURLからID抽出', desc:'チャンネルやメッセージのURLを貼るだけで、各種IDを分解して表示。', cat:'id', catLabel:'ID・特殊リンク', href:'/gbp/tools/channel-url-extract.html' },
  { id:'sheet-webhook', title:'スプレッドシート→Discord通知コード生成', desc:'スプレッドシートの更新をトリガーに、Discordへ自動通知するGASコードを生成。', cat:'webhook', catLabel:'Webhook連携', href:'/gbp/tools/sheet-webhook.html' },
  { id:'rss-forward', title:'RSS/Xポスト→Discord転送ガイド', desc:'RSSフィードやXの投稿をDiscordチャンネルへ自動転送する設定手順とコード。', cat:'webhook', catLabel:'Webhook連携', href:'/gbp/tools/rss-forward.html' },
  { id:'permission-matrix', title:'ロール権限マトリクス表', desc:'よくあるサーバー構成向けの、ロール別おすすめ権限設定テンプレート。', cat:'server', catLabel:'サーバー運営', href:'/gbp/tools/permission-matrix.html' },
  { id:'channel-permission-cheatsheet', title:'チャンネル権限設定チートシート', desc:'お知らせ専用・モデレーター専用など、目的別チャンネル権限プリセット集。', cat:'server', catLabel:'サーバー運営', href:'/gbp/tools/channel-permission-cheatsheet.html' },
  { id:'automod-preset', title:'AutoMod設定プリセット', desc:'スパム・招待リンク荒らし対策など、目的別の自動化ルール設定例。', cat:'server', catLabel:'サーバー運営', href:'/gbp/tools/automod-preset.html' },
  { id:'server-templates', title:'サーバー構成テンプレート集', desc:'コミュニティ系・学習系・ゲーム系など、目的別のチャンネル構成テンプレート。', cat:'server', catLabel:'サーバー運営', href:'/gbp/tools/server-templates.html' },
  { id:'invite-presets', title:'招待リンク設定早見表', desc:'有効期限・使用回数のおすすめ組み合わせを、用途別に一覧化。', cat:'server', catLabel:'サーバー運営', href:'/gbp/tools/invite-presets.html' },
  { id:'banner-sizes', title:'バナー/アイコン推奨サイズ一覧', desc:'サーバーアイコン・バナー・絵文字など、各種画像の推奨サイズと容量制限。', cat:'reference', catLabel:'リファレンス', href:'/gbp/tools/banner-sizes.html' },
  { id:'audit-log-glossary', title:'監査ログの見方', desc:'監査ログに出てくる操作名・用語の意味を、実際の表示画面つきで解説。', cat:'reference', catLabel:'リファレンス', href:'/gbp/tools/audit-log-glossary.html' }
];
