...
var GBP_TOOLS = [
  { id:'ansi-color', title:'文字色変換ツール', desc:'ANSIカラーコードでDiscordのコードブロック内テキストに色をつける。プレビュー確認しながらコピー。', cat:'text', catLabel:'テキスト装飾', href:'tools/ansi-color.html' },
  { id:'markdown-copy', title:'マークダウンコピー', desc:'太字・斜体・見出し・リストなどをGUIで組み立てて、Discord用マークダウンとしてコピー。', cat:'text', catLabel:'テキスト装飾', href:'tools/markdown-copy.html' },
  { id:'id-copy', title:'各種ID形式コピー', desc:'ユーザー・ロール・チャンネル・サーバーIDから、メンション形式やID単体をワンクリックでコピー。', cat:'id', catLabel:'ID・特殊リンク', href:'tools/id-copy.html' },
  { id:'timestamp', title:'タイムスタンプタグ生成', desc:'日時を選ぶだけで <t:unix:R> 形式のタイムスタンプタグを生成。表示形式もその場でプレビュー。', cat:'text', catLabel:'テキスト装飾', href:'tools/timestamp.html' },
  { id:'id-customize', title:'スマホ非対応リンクコピー', desc:'<id:customize> など、スマホアプリのUIから直接コピーできない公式リンクタグの一覧とコピー機能。', cat:'id', catLabel:'ID・特殊リンク', href:'tools/id-customize.html' },
  { id:'snowflake', title:'Snowflake ID変換', desc:'Discord ID(Snowflake)から作成日時を逆算。日時からIDの概算範囲を求める逆変換にも対応。', cat:'id', catLabel:'ID・特殊リンク', href:'tools/snowflake.html' },
  { id:'emoji-copy', title:'絵文字コピー用テキスト生成', desc:'カスタム絵文字の名前とIDから <:name:id> / <a:name:id> 形式のコピー用テキストを生成。', cat:'text', catLabel:'テキスト装飾', href:'tools/emoji-copy.html' },
  { id:'cheatsheet', title:'装飾記法＆メンションチートシート', desc:'スポイラー・引用・コードブロック言語指定・@everyone等のメンション形式を一覧でコピー。', cat:'text', catLabel:'テキスト装飾', href:'tools/cheatsheet.html' },
  { id:'webhook-gform', title:'Googleフォーム→Discord連携コード生成', desc:'フォーム回答をWebhook経由でDiscordチャンネルへ送るApps Scriptコードを、入力項目に合わせて自動生成。', cat:'webhook', catLabel:'Webhook連携', href:'tools/webhook-gform.html' },
  { id:'reference', title:'用語集＆ショートカットキー', desc:'Discord運営でよく使う略語・スラングの解説と、覚えておきたいショートカットキー一覧。', cat:'reference', catLabel:'リファレンス', href:'tools/reference.html' },
